/*
Report Name: Error Log: SECTION 3 - Summary by LO_EVENT_TYPE_ID
Description of the Report: 
Ability to report on Total number of New and Previous error records per Event Type ID. 
User Input Filters:
...
(   
SELECT D1.c3    AS LO_EVENT_TYPE_ID,
...
FROM (SELECT
    ...
    /* Enter EVENT_DATETIME */
    CASE
      WHEN CAST(T1412.EVENT_TYPE_ID AS CHARACTER ( 30 ) ) IS NULL
      THEN 'Others'
      ELSE CAST(T1412.EVENT_TYPE_ID AS CHARACTER ( 30 ) )
    END AS c3
