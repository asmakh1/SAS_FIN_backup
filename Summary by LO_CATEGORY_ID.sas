/*
Report Name: Error Log: SECTION 5 - SUMMARY BY LO_CATEGORY_ID
Description of the Report: 
Ability to report on Total number of New and Previous error records per Error Category ID.
User Input Filters:
...
SELECT D1.c3    AS LO_CATEGORY_ID,
...
FROM  (SELECT
    ...
    /* Enter EVENT_DATETIME */
    CASE
      WHEN CAST(T1412.ERROR_CATEGORY_ID AS CHARACTER ( 30 ) ) IS NULL
      THEN 'Others'
      ELSE CAST(T1412.ERROR_CATEGORY_ID AS CHARACTER ( 30 ) )
    END AS c3
